    ...
    <Carousel
      ...
      <Carousel.Item
        ...
        <Carousel.Caption
          ...
          <p>Sinta-se como um verdadeiro astronauta ao adquirir uma de nossas espaçonaves de alta qualidade. Com design inovador e tecnologia de ponta.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item
        className="carousel-item"
        ...
        <Carousel.Caption
          className="carousel-caption">
          <h2>Aventure-se em missões intergalácticas.</h2>
          <p>
